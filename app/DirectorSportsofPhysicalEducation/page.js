  ...
  const tabs = [
    ...
    <table className="min-w-full border border-black text-black shadow-lg">      <thead>
           ...
           <tbody>
             ...
             <td className='border border-black px-4 py-2'>1997</td>
             <td className='border border-black px-4 py-2'>B.A.</td>
             <td className=' border border-black px-4 py-2'> Shivaji University, Kolhapur</td>
             <td className=' border border-black px-4 py-2'>Geography</td>
             ...
             <td className='border border-black px-4 py-2  bg-gray-200'>M.P.E.</td>
             <td className=' border border-black px-4 py-2 bg-gray-200'>Shivaji University, Kolhapur</td>
             <td className=' border border-black px-4 py-2  bg-gray-200'>Phy.Edu. </td>
             </tr>
            
             <tr>
             <td className='border border-black px-4 py-2'>3</td>
             <td className='border border-black px-4 py-2'>	2001	</td>
             <td className='border border-black px-4 py-2'>	B.P.Ed</td>
             <td className=' border border-black px-4 py-2'> 	Shivaji University, Kolhapur</td>
             <td className=' border border-black px-4 py-2'>Phy.Edu.</td>
             </tr>
             <tr>
             ...
             <td className=' border border-black px-4 py-2 bg-gray-200'>	Pune University, Pune	</td>
             <td className=' border border-black px-4 py-2  bg-gray-200'>Phy.Edu. </td>
             </tr>
             <tr>
             <td className='border border-black px-4 py-2'>5</td>
             <td className='border border-black px-4 py-2'>	2022	</td>
...
>
  ...
  <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
    ...
    Director, Sports of Physical Education
    </h1>
    ...
    <div className=" text-white py-3 px-6 flex items-center space-x-2 text-sm">
      ...
      <span>/</span>
      <span className="text-[#fbbf24] font-semibold">Director, Sports of Physical Education</span>
    </div>
  </div>
</div>
      ...
      <div className="bg-gray-200 w-full px-5 py-6 flex flex-col lg:flex-row items-center justify-center space-y-4 lg:space-y-0 lg:space-x-6">
        <Image
          src="/images/DirectorSportsofPhysicalEducation.jpeg"
          alt="Registrar"
          width={160}
          height={160}
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-2">
          ...
          Prof. Dr. SHINDE UDAY EKANATH

          </h2>
          <p className="font-bold text-base text-gray-900">
          B.A., B.P.Ed., M.P.Ed., SET, Ph.D.
          </p>
          <p className="text-gray-800">Ag. Director, Sports of Physical Education, KBP University, Satara.</p>
        </div>
      </div>
