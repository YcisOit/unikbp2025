...
const Page = () => {
  ...
  const tabs = [
    { id: 1, name: 'About',
       content: (<>
       <div className=' flex justify-center items-center text-gray-900 mb-3 '>  <p><b> Best Teacher Award</b> of Yashavantrao Chavan Institute of Science, Satara.(2015-16)
      <b>Special Appreciation award</b> for development of KIIT ( Karmveer Bhaurao Patil Institute of Information Technology; 07/05/2000 )</p></div>
      ...
      content:
          ...
          <table className="min-w-full border border-black text-black shadow-lg">      <thead>
                 ...
                 <tbody>
                   <tr>
                   <td className='border border-black px-4 py-2'>1</td>
                   <td className='border border-black px-4 py-2'>	2018 to 19</td>
                   <td className='border border-black px-4 py-2'> Controller of Examination</td>
                   <td className=' border border-black px-4 py-2'> YCIS, Satara.</td>
    
                   </tr>
                   <tr>
                   <td className='border border-black px-4 py-2  bg-gray-200'>2</td>
                   <td className='border border-black px-4 py-2  bg-gray-200'>	From 2019 to till date</td>
                   <td className='border border-black px-4 py-2  bg-gray-200'>	Head of Department of Statistics	</td>
                   <td className=' border border-black px-4 py-2 bg-gray-200'> YCIS, Satara </td>
                   </tr>
                   <tr>
                   <td className='border border-black px-4 py-2'>3</td>
                   <td className='border border-black px-4 py-2'>	From 2011 to till date</td>
                   <td className='border border-black px-4 py-2'>Co-ordinator of Department of Animation Science</td>
                   <td className=' border border-black px-4 py-2'> YCIS, Satara </td>
                   </tr>
                   <tr>
                   <td className='border border-black px-4 py-2'>4</td>
                   <td className='border border-black px-4 py-2'>From 2018 to till date</td>
                   <td className='border border-black px-4 py-2'>BoS Chairman of Statistics		</td>
                   <td className=' border border-black px-4 py-2'> YCIS, Satara     </td>
    
                   </tr>
                   <tr>
                   <td className='border border-black px-4 py-2  bg-gray-200'>5</td>
                   <td className='border border-black px-4 py-2  bg-gray-200'>From 2019 to till date</td>
                   <td className='border border-black px-4 py-2  bg-gray-200'>Joint-Director of KIIT	</td>
                   <td className=' border border-black px-4 py-2 bg-gray-200'> 	KBP, University, Satara </td>
                   </tr>
                   <tr>
                   <td className='border border-black px-4 py-2'>6</td>
                   <td className='border border-black px-4 py-2'>	From 2015	</td>
                   <td className='border border-black px-4 py-2'>	Executive committee member & Honorary Professor</td>
                   <td className=' border border-black px-4 py-2'> ayat Institute of Research and Development (RIRD)</td>
    
                   </tr>
                   <tr>
                   <td className='border border-black px-4 py-2  bg-gray-200'>7</td>
                   <td className='border border-black px-4 py-2  bg-gray-200'>_	</td>
                   <td className='border border-black px-4 py-2  bg-gray-200'>Chairman	</td>
                   <td className=' border border-black px-4 py-2 bg-gray-200'> _ </td>
                   </tr>
    ...
    { id: 4, name: 'About Research', content:
      ...
      <table className="min-w-full border border-black text-black shadow-lg">      <thead>
             ...
             <tbody>
               ...
               <td className='border border-black px-4 py-2  bg-gray-200'>04	</td>
               </tr>
               <tr>
               <td className='border border-black px-4 py-2'>3</td>
               <td className='border border-black px-4 py-2'>Papers Presented</td>
               <td className='border border-black px-4 py-2 '>11	</td>
               </tr>
               <tr>
               <td className='border border-black px-4 py-2  bg-gray-200'>4</td>
               <td className='border border-black px-4 py-2  bg-gray-200'>	UGC funded Minor Research Project Completed	</td>
               <td className='border border-black px-4 py-2   bg-gray-200'>_	</td>

               </tr>
               <tr>
               <td className='border border-black px-4 py-2 '>5</td>
               <td className='border border-black px-4 py-2  '>	Recognised Research Guide of Shivaji University, Kolhapur</td>
               <td className='border border-black px-4 py-2  '>_</td>
               </tr>
               <tr>
               <td className='border border-black px-4 py-2 bg-gray-200'>6</td>
               <td className='border border-black px-4 py-2 bg-gray-200'>		Research Guidance	</td>
               <td className='border border-black px-4 py-2 bg-gray-200 '>01 student completed Ph.D. 01 student submitted thesis for Ph.D s 03 students are working for Ph.D.	</td>
    ...
    <div className="w-full lg:w-80 border-2 border-black shadow-lg rounded-2xl p-4 space-y-4 bg-white">
      ...
      <div className="flex items-start space-x-3">
        ...
        <div>
          ...
          <p className="text-gray-800"> dboee@unikbp.ac.in</p>
        </div>
      </div>
      <hr className="h-0.5 bg-gray-600" />
...
>
  ...
  <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
    ...
    <div className=" text-white py-3 px-6 flex items-center space-x-2 text-sm">
      ...
      <span>/</span>
      <span className="text-[#fbbf24] font-semibold">Director BOEE</span>
    </div>
  </div>
</div>
      ...
      <div className="bg-gray-200 w-full px-5 py-6 flex flex-col lg:flex-row items-center justify-center space-y-4 lg:space-y-0 lg:space-x-6">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-2">
          ...
          <p className="text-gray-800">Ag. Director Board of Examinations and Evaluation,KBP University, Satara <br/>Teaching Experience : UG: 28 yrs PG: 11 Years</p>
        </div>
      </div>
