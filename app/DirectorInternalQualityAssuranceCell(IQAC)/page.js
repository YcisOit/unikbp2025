  ...
  const tabs = [
    ...
    <table className="min-w-full border border-black text-black shadow-lg">      <thead>
           ...
           <tbody>
             ...
             <td className=' border border-black px-4 py-2'> Savitribai Phule Pune University, Pune</td>
             <td className=' border border-black px-4 py-2'>Botany</td>

             </tr>
             <tr>
             <td className='border border-black px-4 py-2  bg-gray-200'>2</td>
             <td className='border border-black px-4 py-2  bg-gray-200'>2009</td>
             <td className='border border-black px-4 py-2  bg-gray-200'>M. Phil</td>
             ...
             <td className='border border-black px-4 py-2  bg-gray-200'>2005</td>
    ...
    <p className='font-bold text-base text-gray-900'>BOOKS/REPORTS/CHAPTERS/GENERAL ARTICLES ETC.</p>
      <table className="min-w-full border border-black text-black shadow-lg">      <thead>
             ...
             <tbody>
               <tr>
               <td className='border border-black px-4 py-2'>1</td>
               <td className='border border-black px-4 py-2'>2013 to Till Date</td>
               <td className=' border border-black px-4 py-2'>Assistant Professor</td>
               <td className=' border border-black px-4 py-2'>Yashavantrao Chavan Institute of Science (Autonomous), Satara</td>

               </tr>
               <tr>
               <td className='border border-black px-4 py-2 bg-gray-200'>2</td>
               <td className='border border-black px-4 py-2 bg-gray-200'>2012 to 2013</td>
               <td className=' border border-black px-4 py-2 bg-gray-200'>Assistant Professor</td>
               <td className=' border border-black px-4 py-2 bg-gray-200'>New Arts, Commerce and Science College, Parner; Tal: Parner; Dist: Ahmednagar</td>
    ...
    { id: 4, name: 'About Research', content:
      ...
      <table className="min-w-full border border-black text-black shadow-lg">      <thead>
             ...
             <tbody>
               <tr>
               <td className='border border-black px-4 py-2'>1</td>
               <td className='border border-black px-4 py-2'>	Book</td>
               <td className=' border border-black px-4 py-2'>01</td>
               </tr>
               <tr>
               <td className='border border-black px-4 py-2 bg-gray-200'>2</td>
               <td className='border border-black px-4 py-2 bg-gray-200'>Book Chapter</td>
               <td className=' border border-black px-4 py-2 bg-gray-200'>15</td>
               </tr>
               <tr>
               <td className='border border-black px-4 py-2'>3</td>
               <td className='border border-black px-4 py-2'>Manuscript Published</td>
               <td className=' border border-black px-4 py-2'>39</td>
               </tr>
    ...
    <div className="w-full lg:w-80 border-2 border-black shadow-lg rounded-2xl p-4 space-y-4 bg-white">
      ...
      <div className="flex items-start space-x-3">
        ...
        <div>
          ...
          <p className="text-gray-800"> +91-9552504530</p>
        </div>
      </div>
      <hr className="h-0.5 bg-gray-600" />
      ...
      <div className="flex items-start space-x-3">
        ...
        <div>
          ...
          <p className="text-gray-800"> diriqac@unikbp.ac.in</p>
        </div>
      </div>
      <hr className="h-0.5 bg-gray-600" />
...
>
  ...
  <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
    ...
    <div className=" text-white py-3 px-6 flex items-center space-x-2 text-sm">
      ...
      <span>/</span>
      <span className="text-[#fbbf24] font-semibold">Director, Internal Quality Assurance Cell (IQAC)</span>
    </div>
  </div>
</div>
      ...
      <div className="bg-gray-200 w-full px-5 py-6 flex flex-col lg:flex-row items-center justify-center space-y-4 lg:space-y-0 lg:space-x-6">
        <Image
          src="/images/DirectorInternalQualityAssuranceCell(IQAC).png"
          alt="Registrar"
          width={160}
          height={160}
